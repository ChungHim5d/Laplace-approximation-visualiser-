...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen w-full bg-slate-50 flex flex-col overflow-hidden">
      ...
      <header className="bg-white border-b border-slate-200 px-8 py-4 flex justify-between items-center shrink-0 z-10">
        <div>
            ...
            <p className="text-slate-500 text-sm mt-1 flex items-center gap-1">
              Bayesian Inference & Taylor Series Expansion <Info size={14} />
            </p>
        </div>
        ...
        <div className="flex items-center gap-4">
             <button 
                onClick={handleReset}
                className="flex items-center gap-2 text-slate-600 hover:text-indigo-600 text-sm font-medium transition-colors px-4 py-2 rounded-lg hover:bg-slate-100"
            >
                <RotateCcw size={18} />
                Reset View
            </button>
      ...
      {/* Main Content Grid */}
      <main className="flex-1 grid grid-cols-12 gap-6 p-6 overflow-hidden max-w-[1800px] mx-auto w-full">
        ...
        <div className="col-span-12 lg:col-span-3 flex flex-col gap-6 h-full overflow-y-auto pr-2">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-600 mb-2">Posterior Shape</label>
        ...
        {/* Center: Visualization (Increased to 5 cols) */}
        ...
        {/* Right Sidebar: Explanation (Reduced to 4 cols) */}
        <div className="col-span-12 lg:col-span-4 h-full overflow-y-auto">
            <ExplanationPanel 
                step={step} 
